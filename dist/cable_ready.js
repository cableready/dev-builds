...
var Operations = {
  ...
  insertAdjacentHtml: operation => {
    processElements(operation, (element => {
      ...
      operate(operation, (() => {
        ...
        element.insertAdjacentHTML(position || "beforeend", html != null ? html : "");
        assignFocus(focusSelector);
      }));
      after(element, operation);
    }));
  ...
  insertAdjacentText: operation => {
    processElements(operation, (element => {
      ...
      operate(operation, (() => {
        ...
        element.insertAdjacentText(position || "beforeend", text != null ? text : "");
        assignFocus(focusSelector);
      }));
      after(element, operation);
    }));
  ...
  setStyles: operation => {
    processElements(operation, (element => {
      ...
      operate(operation, (() => {
        ...
        for (let [name, value] of Object.entries(styles)) element.style[name] = value != null ? value : "";
      }));
      after(element, operation);
    }));
  },
  ...
  pushState: operation => {
    ...
    operate(operation, (() => {
      ...
      history.pushState(state != null ? state : {}, title != null ? title : "", url);
    }));
    after(window, operation);
  },
  ...
  replaceState: operation => {
    ...
    operate(operation, (() => {
      const {state: state, title: title, url: url} = operation;
      history.replaceState(state != null ? state : {}, title != null ? title : "", url);
    }));
    after(window, operation);
  },
  ...
  consoleLog: operation => {
    ...
    operate(operation, (() => {
      ...
      level && [ "warn", "info", "error" ].includes(level) ? console[level](message != null ? message : "") : console.log(message != null ? message : "");
    }));
    after(document, operation);
  },
  ...
  notification: operation => {
    ...
    operate(operation, (() => {
      ...
      Notification.requestPermission().then((result => {
        ...
        if (result === "granted") new Notification(title != null ? title : "", options);
      }));
    }));
    after(document, operation);
  }
